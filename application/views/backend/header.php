...
<head>
    ...
    <title><?= isset($page_title) ? $page_title : lang('backend_section') ?></title>
...
<nav id="header" class="navbar navbar-expand-md navbar-dark">
    <div id="header-logo" class="navbar-brand">
        <img src="<?= base_url('assets/img/logoViedma.png') ?>">
        <h6>Hospital Clínico Viedma</h6>
        <small>Sistema de reserva de fichas</small>
    </div>
