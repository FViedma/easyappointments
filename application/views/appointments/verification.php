        ...
        <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
            ...
            <div id="header">
                ...
                <div id="steps">
                    ...
                    <div id="step-0" class="book-step active-step"
                         data-tippy-content="<?= lang('enter_ci_please') ?>">
                        <strong>0</strong>
                    </div>
...
<script src="<?= asset_url('assets/js/frontend_verification_api.js') ?>"></script>
<script src="<?= asset_url('assets/js/frontend_verification.js') ?>"></script>
