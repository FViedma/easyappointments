...
$lang['service_and_provider'] = 'Seleccione Especialidad y Medico';
$lang['select_service'] = 'Seleccione Especialidad';
$lang['select_provider'] = 'Seleccione Medico';
...
$lang['confirm'] = 'Confirmar y descargar ficha';
$lang['update'] = 'Actualizar';
$lang['cancel_appointment_hint'] = 'Presione el botón "Cancelar" para eliminar la cita de la agenda de la institución.';
...
$lang['reason'] = 'Razón';
$lang['appointment_removed_from_schedule'] = 'Se eliminó esta cita de la agenda de la institución.';
...
$lang['service'] = 'Especialidad';
$lang['provider'] = 'Médico';
...
$lang['month'] = 'Mes';
$lang['today'] = 'Hoy';
$lang['not_working'] = 'Fuera del consultorio';
$lang['break'] = 'Pausa';
$lang['add'] = 'Agregar';
$lang['edit'] = 'Editar';
$lang['hello'] = 'Hola';
$lang['all_day'] = 'Todo el día';
$lang['manage_appointment_record_hint'] = 'Gestionar todos las citas agendadas de los medicos y especialidades disponibles.';
$lang['select_filter_item_hint'] = 'Seleccionar un médico o una especialidad y ver las citas en el calendario.';
$lang['enable_appointment_sync_hint'] = 'Habilitar la sincronización de la cita con la cuenta de Google Calendar del médico.';
$lang['manage_customers_hint'] = 'Gestionar los pacientes registrados y ver su historial de citas agendadas.';
$lang['manage_services_hint'] = 'Gestionar los especialidad y las categorías disponibles del sistema.';
$lang['manage_users_hint'] = 'Gestionar usuarios internos (administradores, medicos, asistentes).';
$lang['settings_hint'] = 'Establecer configuración de sistema y usuario.';
$lang['log_out_hint'] = 'Cerrar sesión del sistema.';
$lang['unavailable_periods_hint'] = 'El médico no podrá aceptar nuevas citas cuando se encuentre como No disponible.';
...
$lang['hide'] = 'Ocultar';
$lang['type_to_filter_customers'] = 'Tipee para filtrar pacientes.';
$lang['clear_fields_add_existing_customer_hint'] = 'Limpiar los campos e ingresar un nuevo paciente.';
$lang['pick_existing_customer_hint'] = 'Elegir un paciente existente.';
...
$lang['provider_saved'] = 'Medico guardado exitosamente';
$lang['secretary_saved'] = 'Asistente guardado exitosamente';
$lang['admin_deleted'] = 'Administador eliminado exitosamente';
$lang['provider_deleted'] = 'Medico eliminado exitosamente';
$lang['secretary_deleted'] = 'Asistente eliminado exitosamente';
$lang['service_saved'] = 'Especialidad guardada exitosamente';
$lang['service_category_saved'] = 'Categoría de especialidad guardada exitosamente';
$lang['service_deleted'] = 'Especialidad eliminada exitosamente';
$lang['service_category_deleted'] = 'Categoría de especialidad eliminada exitosamente';
$lang['customer_saved'] = 'Paciente guardado exitosamente';
$lang['customer_deleted'] = 'Paciente eliminado exitosamente';
...
$lang['add_breaks_during_each_day'] = 'Agregar periodos de descanso para cada día. Durante los periodos de descanso los médicos no podrán aceptar ninguna cita.';
$lang['day'] = 'Día';
$lang['days'] = 'Días';
$lang['actions'] = 'Acciones';
$lang['reset_working_plan_hint'] = 'Restaurar el esquema del horario laboral a los valores por defecto.';
$lang['company_name'] = 'Nombre de la institución';
$lang['company_name_hint'] = 'El nombre de la institución aparecerá en todo el sistema (obligatorio).';
$lang['company_email'] = 'Dirección de E-mail de la institución';
$lang['company_email_hint'] = 'Esta será la dirección de E-mail de la institución. Será utilizada como la dirección para enviar E-mails del sistema y recibir respuestas (obligatorio).';
$lang['company_link'] = 'Enlace de la institución';
$lang['company_link_hint'] = 'El enlace de la institución debe dirigir al sitio web oficial de la institución (obligatorio).';
...
$lang['edit_working_plan_hint'] = 'Marque abajo los días y horarios en que su institución aceptará citas. Será posible agendar citas fuera del horario de trabajo, pero los pacientes no podrán agendar citas ellos mismos en esos horarios.  Este será el esquema del horario laboral por defecto para todos los nuevos médicos registrados, pero podrá cambiar el esquema de cada médico editando su registro. Luego se podrá agregar periodos de descanso.';
$lang['edit_breaks_hint'] = 'Agrgar los periodos de descanso de trabajo en cada día. Se aplicarán estos periodos de descanso para todos los nuevos médicos.';
$lang['book_advance_timeout'] = 'Agendar tiempos muertos';
$lang['book_advance_timeout_hint'] = 'Defina el tiempo muerto (en minutos) antes que de los pacientes puedan agendar o reorganizar citas con la institución.';
$lang['timeout_minutes'] = 'Tiempo muerto (en minutos)';
$lang['about_app_info'] = 'Easy!Appointments es un aplicativo web completamente personalizable que le permitirá a sus pacientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
...
$lang['delete_service'] = 'Eliminar Especialidad';
$lang['delete_category'] = 'Eliminar Categoría de especialidad';
$lang['delete_provider'] = 'Eliminar Medico';
...
$lang['any_provider'] = 'Cualquier Medico';
...
$lang['customer_notifications'] = 'Notificaciones de Pacientes';
$lang['customer_notifications_hint'] = 'Define si su paciente recibirá notificaciones de correo cada vez que una agenda cambia o alguna de sus citas.';
...
$lang['require_phone_number_hint'] = 'Cuando está habilitado, pacientes y usuarios deberán ingresar el número de teléfono del cliente al registrar una cita.';
...
$lang['overwrite_existing_working_plans'] = 'Esto sobreescribirá los planes de trabajo existentes del medico. ¿Seguro que desea continuar?';
$lang['working_plans_got_updated'] = 'Todos los planes de trabajo fueron actualizados.';
$lang['apply_to_all_providers'] = 'Aplicar a todos los medicos';
$lang['display_any_provider'] = 'Opción de mostrar cualquier médico';
$lang['display_any_provider_hint'] = 'La página de reserva tendrá una opción adicional que permitirá que los pacientes se anoten sin específicar un medico.';
$lang['load_more'] = 'Cargar más';
$lang['list'] = 'Lista';
$lang['default'] = 'Predeterminado';
$lang['table'] = 'Tabla';
$lang['date'] = 'Fecha';
$lang['enter_ci_please'] = 'Ingrese su Cédula de identidad por favor';
$lang['identification'] = 'Cedula de identidad';
...
$lang['patient_not_registered'] = 'Usted no se encuentra en el sistema, es paciente nuevo, por favor tiene que apersonarse por el hospital no puede hacer una reserva en línea';
$lang['message'] = 'Mensaje';
$lang['patient_registered'] = 'Paciente registrado';
$lang['is_institutional'] = 'Es paciente institucional';
$lang['is_institutional_question'] = 'Usted es paciente que está viniendo de otro centro de salud?';
$lang['select_an_answer'] = 'Seleccione una respuesta';
$lang['medical_center'] ='Nombre del centro de salud';
...
$lang['reference_label'] = 'Referencia';
...
$lang['reports_hint'] = 'Generar reportes varios.';
$lang['reports'] = 'Reportes';
$lang['by_specialities'] = 'Por especialidades';
$lang['by_ci'] = 'Por carnet de identidad';
$lang['by_user'] = 'Programados por usuarios';
$lang['all_specialities'] = 'TODAS LAS ESPECIALIDADES';
$lang['all_users'] = 'TODOS LOS USUARIOS';
$lang['print'] = 'imprimir reporte';
$lang['appointments_by_speciality'] = 'Citas por especialidades';
$lang['appointments_by_patient_id'] = 'Citas por ci';
$lang['diagnostic'] = 'Diagnóstico';
$lang['select_report_date'] = 'Fecha Inicio';
$lang['select_report_date_end'] = 'Fecha Fin';
...
$lang['ticket_recomendation_first'] = 'Se le recuerda que debe apersonarse al establecimiento con';
$lang['ticket_recomendation_first_time'] = '2 HORAS DE ANTICIPACIÓN';
...
$lang['peso'] = 'PESO:';
$lang['talla'] = 'TALLA:';
$lang['sintomas_covid'] = 'SINTOMAS COVID: SI ...... No .......';
$lang['otros'] = 'OTROS:';
$lang['vacunado'] = 'VACUNADO: SI ...... NO ......';
$lang['dosis'] = 'DOSIS:';
$lang['admision'] = 'Horario de Admision en la Mañana desde las 6:00 AM y en la tarde desde las 12:30 PM';
$lang['FirstAdmisionSch'] = 'POR FAVOR ASISTIR 2 HORAS ANTES';
$lang['SecondAdmisionSch'] = 'DE SU CONSULTA PROGRAMADA';
$lang['ThirdAdmisionSch'] = 'CASO CONTRARIO NO SERA ATENDIDO';
$lang['reprint'] = 'Reimprimir Ficha';
$lang['select_all'] = ' Seleccionar Todo';
$lang['user'] = 'Usuario';
$lang['booked'] = 'Fecha Reserva';
$lang['quantity_appointments']='Cantidad de reservas';
$lang['dates_report_error']='Las fecha de fin debe ser mayor a la fecha de inicio';