 ...
 * @param {String} complement patient's ci complement
    ...
    function printTicket(data, hash, number) {
        ...
        var vitalSignsXpos1 = logoposX
        var vitalSignsXpos2 = logoposX
        var vitalSignsXpos3 = logoposX
        ...
        doc.setFontSize(fontTextSize)
        doc.text(logoposX + 233, fontTextStartYPos, EALang.ticket_recomendation_first_time);
        doc.setFontSize(fontFinalTextSize)
        ...
        //ficha de signos
        doc.text(logoposX, fontTextStartYPos += fontFinalTextSize + 15, EALang.sv);
        doc.text(vitalSignsXpos1 += fontVitalSigns, fontTextStartYPos, EALang.fc);
        doc.text(vitalSignsXpos1 += fontVitalSigns, fontTextStartYPos, EALang.t);
        doc.text(vitalSignsXpos1 += fontVitalSigns, fontTextStartYPos, EALang.sat_o);
        doc.text(vitalSignsXpos1 += fontVitalSigns, fontTextStartYPos, EALang.pa);
